  ...
  return (
    <Box>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-evenly", py: "4rem", ml: "4rem" }}>
        ...
        Anna Müller is a highly skilled and compassionate yoga instructor, known for her ability to create a welcoming and calming atmosphere in her classes. With years of experience and a deep understanding of yoga philosophy, she empowers her students to find physical and mental balance on their personal wellness journeys.
        </Typography>
        </Box>
      </Box>
      <Box sx={{ display: "flex", justifyContent: "space-evenly", py: "4rem", ml: "4rem" }}>
