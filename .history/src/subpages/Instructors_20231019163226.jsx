...
const Instructors = () => {
  return (
    <Box>
      ...
      <Box sx={{ display: "flex", flexDirection:"column" justifyContent: "space-evenly", py: "4rem", ml: "4rem" }}>
        <Typography sx={{  mt: "6rem", border:"1px solid red" }} variant="h5">
        Christoph Weber
        </Typography>
        <Typography sx={{  mt: "1rem", border:"1px solid red" }} variant="h5">
        Christoph Weber
        </Typography>
        <CardMedia
          component="img"
