  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Typography color={grey[100]} sx={{border:"1px solid red"}}>Subscribe to Our Newsletter</Typography>
          <Typography color={grey[100]}>Sign up to receive news and updates.</Typography>
          <Button
            sx={{
              backgroundColor: grey[100],
              color: grey[800],
