    ...
    <Box>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-evenly", py: "4rem", ml: "4rem" }}>
        <Box sx={{ width: "40%" }}>
          ...
          <Typography sx={{ mt: "1rem" }} variant="h6" color={grey[700]}>
          Yoga aerobic classes blend the flowing movements and intensity of aerobic exercises with the mindfulness and breathing techniques of yoga, promoting both physical fitness and stress reduction in a single dynamic workout.
          </Typography>
        </Box>
        <CardMedia
          component="img"
