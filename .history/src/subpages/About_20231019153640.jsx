...
const About = () => {
  return (
    <Box>
      ...
      <Box sx={{justifyContent:"center", alignItems}}>
        <CardMedia component="img" alt="Card Image" image={image1} />
        <Typography color={grey[100]} sx={{position:"absolute", zIndex: 1}}>“This is the perfect place for a testimonial, quote or statement.”</Typography>
      </Box>
    </Box>
  );
};
