  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <Typography color={grey[100]} sx={{position:"absolute", zIndex: 1, justifyContent:"cente"}}>“This is the perfect place for a testimonial, quote or statement.”</Typography>
      </Box>
    </Box>
  );
};
