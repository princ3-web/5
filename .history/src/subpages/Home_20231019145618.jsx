...
import { Box, CardMedia, Typography, Button, TextField } from "@mui/material";
    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Typography color={grey[100]} textAlign={"center"} variant="h6" sx={{ mt: "1rem" }}>
            Sign up to receive news and updates.
          </Typography>
          <Box sx={{ mt: "1rem" }}>
          <TextField id="filled-basic" label="Filled" variant="filled" sx={{ color: grey[100], border: "1px solid " + grey[100] }} />
            <TextField
              id="outlined-basic"
              label="Outlined"
              variant="filled"
              sx={{ color: grey[100], border: "1px solid " + grey[100] }}
            />
            <Button
              sx={{
                backgroundColor: grey[500],
