...
import { Box, Card, CardMedia, Typography, Butto } from "@mui/material";
    ...
    <Box>
      ...
      <Box sx={{ backgroundColor: grey[800], p: "4rem", boxSizing: "border-box" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
          <Box sx={{ display:"flex", width: "49%", justifyContent:"center", alignItems:"center" }}>
            <CardMedia component="img" alt="Card Image" image={image2} />
            <Typography variant="h4" color={grey[100]} sx={{ position: "absolute", zIndex: "1" }}>Yoga Aerobics</Typography>
          </Box>
          <Box sx={{ display:"flex", width: "49%", justifyContent:"center", alignItems:"center" }}>
            <CardMedia component="img" alt="Card Image" image={image3} />
            <Typography variant="h4" color={grey[100]} sx={{ position: "absolute", zIndex: "1" }}>Instructor Training</Typography>
          </Box>
        </Box>
