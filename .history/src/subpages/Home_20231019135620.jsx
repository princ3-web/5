...
const Home = () => {
  return (
    <Box>
      ...
      <Box sx={{backgroundColor: grey[800], px: "4rem", boxSizing:"border-box"}}>
          <Typography color={grey[100]} variant="h3" sx={{pt:"4rem", pb: "1rem"}}>Upcoming classes</Typography>
          <Box sx={{display:"flex", justifyContent:"space-between"}}>
          <CardMedia component="img" alt="Card Image" image={image1} sx={{width:"48%"}} />
          <CardMedia component="img" alt="Card Image" image={image1} sx={{width:"50%"}} />
          </Box>
      </Box>
    </Box>
  );
