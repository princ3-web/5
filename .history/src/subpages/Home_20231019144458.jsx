  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Typography color={grey[100]}  textAlign={"center"}>Subscribe to Our Newsletter</Typography>
          <Typography color={grey[100]} textAlign={"center"}>Sign up to receive news and updates.</Typography>
          <Button
            sx={{
              backgroundColor: grey[100],
              color: grey[800],
