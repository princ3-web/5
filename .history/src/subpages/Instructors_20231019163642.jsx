  ...
  return (
    <Box>
      ...
      <Box sx={{width: "40%"}}>
          ...
          <Typography sx={{ mt: "1rem" }} variant="h6">
          dedicated and experienced yoga instructor who brings a strong emphasis on alignment and mindfulness to his classes. His teaching style combines traditional yoga practices with a modern approach, creating a space where students can deepen their mind-body connection and achieve a profound sense of inner peace and well-being.
